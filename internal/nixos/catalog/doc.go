...
//
// A catalog is one ZIP containing its release tag, upstream LICENSE, and module trees. Its ZIP comment identifies [Repository];
...
//
// [Open] validates archive paths, file types, contents, and metadata before exposing read-only module filesystems. It neither
