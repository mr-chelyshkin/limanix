...
var (
	...
	ErrInvalidModuleID      = errors.New("expected a qualified module identifier: CATALOG:NAME[-VERSION]")
	ErrInvalidModuleVersion = errors.New("expected a numeric module version, such as 28 or 1.24")
