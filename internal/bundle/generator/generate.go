// Package generator builds and verifies the Linux guest-agent resources embedded by bundle.
// It prepares build-time assets independently of bundle's runtime cache.
package generator
...
// builtArtifact holds a verified archive until every target has built successfully.
...
// root selects the repository containing go.mod; diagnostics receives progress and compiler output.
// Raw executables live only in a system temporary directory outside embedded resources.
