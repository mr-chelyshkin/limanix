...
//
// The example is also mounted as a downloadable Hugo asset. Handwritten pages, layouts, and site configuration
// remain under docs; generated references are included by those pages rather than maintained as separate copies.
//
